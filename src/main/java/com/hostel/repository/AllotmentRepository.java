...
public interface AllotmentRepository extends JpaRepository<Allotment, Long> {
    ...
    // =====================================================
    // STAGE 3: SPOT ROUND QUERIES
    // =====================================================

    List<Allotment> findByGenderAndAllotmentRound(String gender, String allotmentRound);

    List<Allotment> findByGenderAndAllotmentRoundOrderByAggregateDesc(String gender, String allotmentRound);

    List<Allotment> findByGenderAndAllotmentStatusIn(String gender, List<String> statuses);

    List<Allotment> findByGenderAndAllotmentRoundAndAllotmentStatusIn(String gender, String allotmentRound, List<String> statuses);

    List<Allotment> findByAllotmentRound(String allotmentRound);

    void deleteByGenderAndAllotmentRound(String gender, String allotmentRound);
}