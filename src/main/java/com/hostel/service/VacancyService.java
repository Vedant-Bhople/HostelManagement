...
public class VacancyService {
    ...
    public Map<String, Object> getVacancy(
        ...
        int totalSeats = ReservationPolicy.getTotalCapacity(gender);
        ...
        for (Allotment allotment : allotments) {
            String status = allotment.getAllotmentStatus();
        ...
        int availableSeats = totalSeats - allottedSeats;
        if (availableSeats < 0) {
            availableSeats = 0;
        }
        ...
        result.put("allottedSeats", allottedSeats);
        result.put("acceptedSeats", acceptedSeats);
