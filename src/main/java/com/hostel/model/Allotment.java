...
public class Allotment {
    ...
    // =====================================================
    // MERIT LIST RECORD (Optional for Spot Round)
    // =====================================================

    @ManyToOne
    @JoinColumn(name = "merit_list_id", nullable = true)
    private MeritList meritList;


    // =====================================================
    // ALLOTMENT ROUND (REGULAR / SPOT)
    // =====================================================

    private String allotmentRound = "REGULAR";
    ...
    // Normalized common category used for reservation matching (OPEN, OBC, SBC, SC, ST, NT, SEBC)
    private String commonCategory;

    // Category used for seat allotment (e.g. OPEN, OPEN/SEBC, OBC/SBC, SC/ST, NT, AGAINST_NT_SC_ST)
    private String allotmentCategory;

    // Flag indicating whether this seat was allotted via unused reserved seat conversion
    ...
    public String getAllotmentRound() {
        return allotmentRound;
    }

    public void setAllotmentRound(String allotmentRound) {
